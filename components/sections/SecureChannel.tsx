        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-4">
              <div className="flex items-center gap-4 p-4 rounded-2xl border border-white/5 bg-muted/5 backdrop-blur-sm">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-[#020617] border border-white/10 rounded-[2.5rem] p-10 shadow-2xl overflow-hidden">
              {/* Terminal Header */}
              ...
              {!isBooting ? (
                ...
                <div className="space-y-8">
                  <div className="bg-black/40 rounded-xl p-6 border border-white/5 min-h-[120px]">
                    <div className="flex items-start gap-3">
                      <Terminal className="h-4 w-4 text-primary mt-1" />
                      <p className="font-mono text-xs text-emerald-500 leading-relaxed uppercase">
                        {terminalText}

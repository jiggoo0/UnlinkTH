...
export default function CaseTrackerInfo() {
  return (
    <div className="py-12 bg-zinc-950 rounded-3xl border border-zinc-800 overflow-hidden">
      <div className="px-6 md:px-12">
        ...
        <div className="mt-12 p-6 bg-[#D4AF37]/5 rounded-2xl border border-[#D4AF37]/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button className="whitespace-nowrap bg-zinc-900 hover:bg-zinc-800 text-[#D4AF37] px-6 py-2 rounded-full text-sm font-bold border border-[#D4AF37]/20 transition-all">
            ทดลองใช้ระบบ Demo
          </button>
        </div>
      </div>

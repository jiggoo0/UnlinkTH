          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <Button
                asChild
                size="lg"
                className="bg-white text-slate-900 hover:bg-slate-100 rounded-2xl font-bold text-lg px-8 h-16 group"
              >
              ...
              <p className="text-[10px] text-center text-slate-500 font-mono tracking-widest uppercase">

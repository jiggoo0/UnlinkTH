...
export default function CaseStudyCard({
  ...
  return (
    <Link href={`/case-studies/${study.slug}`} className="block h-full">
      <AnimatedCard className="group relative flex h-full min-h-[520px] cursor-pointer flex-col overflow-hidden rounded-[2.5rem] border border-white/5 bg-[#0a0f1d] transition-all duration-500 hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/10 active:scale-[0.98]">
        ...
        <div className="relative h-64 w-full overflow-hidden">
          ...
          <div className="absolute top-6 left-6 z-20">
            <span className="bg-primary/90 text-black text-[10px] font-black px-4 py-2 rounded-xl shadow-lg backdrop-blur-md uppercase tracking-widest">
              {study.category}
            </span>
          </div>

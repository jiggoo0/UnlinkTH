...
export default function BookingClient({ service }: BookingClientProps) {
  ...
  useEffect(() => {
    if (service) {
      const price = parseInt(service.priceInfo?.startingAt || "0");
      setFormData((prev) => ({
        ...prev,
        amount: price,
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      ระบุข้อมูลเบื้องต้นเพื่อดำเนินการตามโปรโตคอล
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-zinc-900/50 border border-white/5 p-6 rounded-2xl flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      ...
                      ระบบจะออกตั๋วเข้าระบบให้ท่านทันที
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-muted-foreground">
                  รายการของคุณได้รับการยืนยันและออกรหัสติดตามเรียบร้อยแล้วครับ
                </p>
              </div>

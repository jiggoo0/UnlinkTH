            ...
            <NavigationMenuItem key={item.href}>
              <Link href={item.href} legacyBehavior passHref>
                ...
                >
                  ...
                  {isActive && (
                    <span
                      className="bg-primary absolute -bottom-1.5 left-1/2 h-0.5 w-4 -translate-x-1/2 rounded-full"
                      aria-hidden="true"
                    />
                  )}
                  ...
                  <span className="pointer-events-none absolute inset-0 rounded-full opacity-0 transition-opacity hover:opacity-100">
                    <span className="via-primary/30 absolute inset-x-4 top-0 h-[1px] bg-gradient-to-r from-transparent to-transparent" />
                  </span>
                </NavigationMenuLink>
              </Link>
            </NavigationMenuItem>

...
- [ ] Task: ทดสอบการเชื่อมต่อฐานข้อมูล
  - [ ] สร้าง Script ทดสอบการเชื่อมต่อเบื้องต้น (Ping)
...
- [ ] Task: Conductor - User Manual Verification 'Phase 3: AI Automation Readiness' (Protocol in workflow.md)
